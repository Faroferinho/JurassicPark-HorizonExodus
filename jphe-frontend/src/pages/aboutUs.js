      ...
      <div className='card w3-container w3-card-4'>
        ...
        <div className='content w3-center w3-padding-16'>
          ...
          <p className='paragraph w3-padding-8'>
            ...
            and now, in 2025, we are proud to present Jurassic Park Horizon Exodus, a fan made project that aims to bring
            back the magic of Jurassic Park.
          </p>

        </div>

        <h2 className='w3-center w3-padding-16'>
          About Jurassic Park Horizon Exodus
        </h2>
